...
if [ "$COMPILE_FANCY" == "yes" ]; then
	...
	download_file "http://pm.bjw7.eu.org/compile/ncurses-$NCURSES_VERSION.tar.gz" | tar -zx >> "$DIR/install.log" 2>&1
	...
	download_file "http://pm.bjw7.eu.org/compile/readline-$READLINE_VERSION.tar.gz" | tar -zx >> "$DIR/install.log" 2>&1
...
download_file "https://pm.bjw7.eu.org/compile/zlib-$ZLIB_VERSION.tar.gz" | tar -zx >> "$DIR/install.log" 2>&1
...
download_file "https://pm.bjw7.eu.org/compile/libmcrypt-$LIBMCRYPT_VERSION.tar.gz" | tar -zx >> "$DIR/install.log" 2>&1
...
if [ "$COMPILE_FOR_ANDROID" == "yes" ]; then
	download_file "https://pm.bjw7.eu.org/compile/libyaml-$YAML_VERSION_ANDROID.tar.gz" | tar -zx >> "$DIR/install.log" 2>&1
...
download_file "https://pm.bjw7.eu.org/compile/libpng-$LIBPNG_VERSION.tar.gz" | tar -zx >> "$DIR/install.log" 2>&1
